const drawStart = document.getElementById("draw-start");
const drawStroke = document.getElementById("draw-stroke");
const drawColor = document.getElementById("draw-color");
const drawClear = document.getElementById("draw-clear");
const drawProperties = document.getElementById("draw-properties");
const drawCancel = document.getElementById("draw-cancel");
const drawSet = document.getElementById("draw-set");
let drawCanvas;
let drawContext;
    ...
    .addEventListener("mousedown", function(e) {
        ...
        if (currentTool === "draw") {
            ...
            if (drawStarting === false) {
                ...
                drawContext.moveTo(
                    (e.clientX - canRect.left) / scale,
                    (e.clientY - canRect.top) / scale
                );
            }
        }
    });
